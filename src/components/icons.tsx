export function HomeIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M5 8.5V16a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V8.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ProfileIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M3.5 17c1.2-3.5 4-5.2 6.5-5.2s5.3 1.7 6.5 5.2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export function JobsIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M16.5 16.5 13 13" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export function ApplicationsIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M7 7h6M7 10.2h6M7 13.4h3.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export function BriefcaseIcon() {
  return (
    <svg width="19" height="19" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M7 6V4.5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1V6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
...
export function LogoutIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 20 20" fill="none">
      <path d="M8 17H4.5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1H8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12.5 13.5 16 10l-3.5-3.5M16 10H7.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
