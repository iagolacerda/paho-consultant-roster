...
// O tipo completo do formulário (ConsultantProfileFormValues) é inferido a
// partir do schema zod em ./schema — assim schema e tipo nunca dessincronizam.
// EMPTY_PROFILE (valores padrão) também vive lá, junto do schema que os valida.
export type { ConsultantProfileFormValues } from './schema';
